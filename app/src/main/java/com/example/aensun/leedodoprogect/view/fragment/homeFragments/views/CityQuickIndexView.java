package com.example.aensun.leedodoprogect.view.fragment.homeFragments.views;
...
import com.example.aensun.leedodoprogect.view.fragment.homeFragments.utils.DensityUtil;

/**
 * Created by kun on 2016/10/26.
 * 快速索引
 */
public class CityQuickIndexView extends View {
    ...
    public CityQuickIndexView(Context context) {
        this(context,null);
    }

    public CityQuickIndexView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CityQuickIndexView(Context context, AttributeSet attrs, int defStyleAttr) {
